...
class SliderElements extends AbstractMetabox {
    ...
    public function action_enqueue_style() {
        wp_enqueue_style( 'wizzaro-partners-slider-metabox-elements-css', PluginConfig::get_instance()->get_css_admin_url() . 'metabox-elements.css' );
    }
    ...
    public function save( $post_id, $post ) {
        ...
        if ( isset ( $_POST['wizzaro_partner_elems_list'] ) && is_array( $_POST['wizzaro_partner_elems_list'] ) ) {
            $elements_post_type = SlidersPostTypes::get_instance()->get_post_type( $post->post_type )->get_setting( 'elements_post_type' );
            
            foreach( $_POST['wizzaro_partner_elems_list'] as $elem_id ) {
